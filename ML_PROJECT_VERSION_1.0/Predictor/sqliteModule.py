...
class sql_functions():
    ...
    def update_data(self,table_name,*information,get_null = 0,print_query = 0):
        ...
        # 4-(tablo_ismi,Güncellenecek kolon,Diğer kolon,Güncellenecek kolonun değeri,diğer kolonun değeri,get_null = 1)
    ...
    def addColumn(self,table_name,columnInfo):
        ...
        if columnInfo not in conf:
            ...
            print("[EXISTENCE ERROR]Specified Column Already Exists....")